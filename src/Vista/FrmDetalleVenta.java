...
import Controlador.ControladorventaDetalle;
...
public class FrmDetalleVenta extends javax.swing.JFrame {
    ControladorventaDetalle cnt;
    /**
     * Creates new form FrmDetalleVenta
     */
    public FrmDetalleVenta() {
        initComponents();
        cnt = new ControladorventaDetalle();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ID Venta Detalle:");
        ...
        getContentPane().add(btnMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 250, -1, -1));
        ...
        getContentPane().add(btnElimina, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 250, -1, -1));
    ...
    private void btnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarActionPerformed
        tblDetalleCompra.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String[]{
                "ID Venta Detalle", "ID Venta", "ID Articulo", "Cantidad"
            }
        ));
